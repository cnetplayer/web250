...
<section class="forms">
	...
	<form id="fizzInput" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"><h3>Select TYPE OF TEA to try:</h3>
		<p>
	...
	<input id="endNumber" name="submit" type="submit" value="Let's Get Started">
	</p>
	</form>
<div id="fizzbuzz">
<?php
